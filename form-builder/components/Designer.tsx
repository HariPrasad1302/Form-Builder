...
import { idGenerator } from '@/lib/idGeneerator'
    ...
    useDndMonitor({
        onDragEnd: (event: DragEndEvent) => {
            ...
            if(droppingSidebarBtnOverDesignerElement){
                ...
                let indexForNewElement = overElementIndex; // i assume i am on top
            ...
            {mouseIsOver && (
                <>
                    ...
                    <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-pulse'>
                        <p className='text-muted-foreground tex-sm'>Click for properties or drag to move</p>
                    </div>
                </>
            )}
            {topHalf.isOver && (
